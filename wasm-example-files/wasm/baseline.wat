(module
    (func $test (type $utx_f) (param $tx i32) (param $utx i32) (param $state i32) (result i32)
        i32.const 0
    )
    ...
    (func $__enter (param i64 i64 i32) (result i32)
      ...
      i32.const 0 ;; table entry for first function
    )
    ...
    (func $__get_balance (param i64) (result i64)
      local.get 0
      i32.wrap_i64
      i32.const 3
      i32.shl
